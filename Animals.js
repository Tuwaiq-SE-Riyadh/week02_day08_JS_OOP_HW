...
class Animal{
    ...
    print(){
        const p = "name "+this.name+" age "+this.age+" sound "+this.sound
        return p
    }
}
...
class Cat extends Animal {
    ...
    print(){
        const p = "The name is "+this.name+", age "+this.age+", sound is"+this.sound+", owner "+this.owner+". "+this.eats()+". "+this.Animalsound()
        return p
    }
  }
...
//     * override the `eats` method and make it return `"fish eats flakes"`. 
  ...
  class Fish extends Animal {
    ...
    print(){
        const p = "The name is "+this.name+", age "+this.age+", "+" color "+this.color+". "+this.eats()
        return p
    }
}
